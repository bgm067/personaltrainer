...
function Traininglist() {
    ...
    const columns = [
        ...
        { field: 'date', sortable: true, filter: true, width: "150%", valueFormatter: dateFormatter },
        { field: 'duration', headerName:"Duration (min)", sortable: true, filter: true, width: "150%"  },
        { field: 'customer.firstname', sortable: true, filter: true, width: "200%" },
        { field: 'customer.lastname', sortable: true, filter: true, width: "200%"  },
